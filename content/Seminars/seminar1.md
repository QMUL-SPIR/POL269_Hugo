...
+------------------------------------------------------------------------------------------+-----------------------------------+
| You can use the cursor or arrow keys on your keyboard to edit your code at the console:\ | ![](./img/rstudio_cursorkeys.png) |
